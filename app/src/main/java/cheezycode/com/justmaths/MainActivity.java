    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMathShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "Simple Maths - Fun way to learn Maths. Download here http://bit.ly/SimpleMathApp");
        ...
        btnMathRate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                Toast.makeText(MainActivity.this,"App is still under construction.",Toast.LENGTH_SHORT).show();
                Toast.makeText(MainActivity.this,"Best Regards Saurav Gupta",Toast.LENGTH_LONG).show();
            }
        });
    }
}
